...
cat /etc/openvpn/server.crt >> /home/panel/html/client.ovpn
echo '</cert>' >> /home/panel/html/client.ovpn
echo '<key>' >> /home/panel/html/client.ovpn
cat /etc/openvpn/server.key >> /home/panel/html/client.ovpn
echo '</key>' >> /home/panel/html/client.ovpn
...
cp /etc/openvpn/client-template1.txt /home/panel/html/sam.ovpn
echo '<ca>' >> /home/panel/html/sam.ovpn
cat /etc/openvpn/ca.crt >> /home/panel/html/sam.ovpn
echo '</ca>' >> /home/panel/html/sam.ovpn
}
